...
export function ClearingPaymentModal({ agentId, periodStart, periodEnd, onClose, onSaved }) {
  ...
  async function handleSave() {
    ...
    setSaving(true)
    const { error } = await supabase.from('clearing_agent_payments').insert({
      agent_id:       agentId,
  ...
  return (
    <Modal title="Record Payment to Clearing Agent" onClose={onClose}>
