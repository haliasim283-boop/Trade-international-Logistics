...
export function CassPaymentModal({ periodId, airlineId, onClose, onSaved }) {
  ...
  async function handleSave() {
    ...
    setSaving(true)
    const { error } = await supabase.from('cass_payments').insert({
  ...
  return (
    <Modal title="Record CASS Payment" onClose={onClose}>
