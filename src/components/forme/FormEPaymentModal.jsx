...
export function FormEPaymentModal({ supplierId, periodStart, periodEnd, onClose, onSaved }) {
  ...
  async function handleSave() {
    ...
    setSaving(true)
    const { error } = await supabase.from('form_e_payments').insert({
  ...
  return (
    <Modal title="Record Payment to Form E Supplier" onClose={onClose}>
